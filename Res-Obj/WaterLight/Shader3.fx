// Water_CalmLake.fx - Calm lake with 8 golden-angle Gerstner waves with scene lighting
...
float4 WaterPS(VS_OUTPUT input) : COLOR
{
    ...
    float3 skyColor = float3(0.55, 0.70, 0.85) * LightColor;
    ...
    baseColor += float3(0.03, 0.06, 0.05) * NdotL * LightColor;
